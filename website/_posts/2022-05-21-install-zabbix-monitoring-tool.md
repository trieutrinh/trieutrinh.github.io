...
image:
  path: /assets/img/posts/2022-05-21-install-zabbix-monitoring-tool/featured.webp
  lqip: ""  # TODO
...
![AGE](/assets/img/posts/2022-05-21-install-zabbix-monitoring-tool/age_logo.webp)
...
![age-keygen command output](/assets/img/posts/2022-05-21-install-zabbix-monitoring-tool/terminal_age_keygen.webp)
...
![age-keygen command output to file](/assets/img/posts/2022-05-21-install-zabbix-monitoring-tool/terminal_age_keygen_file.webp)
_`age-keygen` command output redirection to `keys.txt`_

### Encrypting and Decrypting Files

![AGE Encryption and Decryption Diagram](/assets/img/posts/2022-05-21-install-zabbix-monitoring-tool/age_encryption_diagram.webp)
...
![AGE-encrypted File](/assets/img/posts/2022-05-21-install-zabbix-monitoring-tool/age_file_encrypted.webp)
...
![Mozilla SOPS](/assets/img/posts/2022-05-21-install-zabbix-monitoring-tool/sops_logo.webp)
_Mozilla SOPS Logo_
...
![The `sops` config file](/assets/img/posts/2022-05-21-install-zabbix-monitoring-tool/sops_config.webp)
...
![The `sops --decrypt` command failing due to missing age key](/assets/img/posts/2022-05-21-install-zabbix-monitoring-tool/sops_decrypt_fail.webp)
...
![Naming convention diagram](/assets/img/posts/2022-05-21-install-zabbix-monitoring-tool/naming_convention.webp)
...
![The `sops` wrapper bash scripts](/assets/img/posts/2022-05-21-install-zabbix-monitoring-tool/bash_scripts.webp)
...
![That's all Folks](/assets/img/posts/2022-05-21-install-zabbix-monitoring-tool/thats_all_folks.jpg)
